...
/*
  ...
  Reason:
  - The personnel search is handled entirely on the client side using JavaScript and DOM filtering.
  - This endpoint performs a database-level search, which is not currently required.
  - Keeping this file for potential future use if server-side search or pagination is introduced.
*/
